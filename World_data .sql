...
SELECT * FROM world.country
where IndepYear between 1920 and 1978;
...
Select * from world.country
where Region IN ('Eastern Africa','Western Africa','Antarctica');




 select * from world.country
 where Continent = 'Antarctica' and Region = 'Antarctica';
 
 

select * from world.country
 where Region = 'Western Africa' or GovernmentForm = 'Democracy';
